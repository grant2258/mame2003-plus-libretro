...
static PORT_READ_START( sqix_readport )
	...
	{ 0x0800, 0x77ff, MRA_RAM },
	{ 0x8800, 0xf7ff, MRA_RAM },
PORT_END
...
INPUT_PORTS_START( hotsmash )
	...
	PORT_START
	PORT_ANALOG( 0xff, 0x00, IPT_DIAL | IPF_PLAYER1 | IPF_CENTER, 15, 30, 0, 0 )
	
	PORT_START
	PORT_ANALOG( 0xff, 0x00, IPT_DIAL | IPF_PLAYER2 | IPF_CENTER, 15, 30, 0, 0 )
